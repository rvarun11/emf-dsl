 ...
 * @generated
 */
public class FestFairMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = festFair.diagram.part.FestFairDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			festFair.diagram.part.FestFairDiagramEditorUtil.selectElementsInDiagram(editor,
