 ...
 * @generated
 */
public class StallNameDurationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StallNameDurationEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new festFair.diagram.edit.policies.FestFairTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return festFair.diagram.providers.FestFairElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = festFair.diagram.providers.FestFairParserProvider.getParser(
					festFair.diagram.providers.FestFairElementTypes.Stall_3003, getParserElement(),
					festFair.diagram.part.FestFairVisualIDRegistry
							.getType(festFair.diagram.edit.parts.StallNameDurationEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					festFair.diagram.edit.parts.FestFairEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
