 ...
 * @generated
 */
public class FairDayNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FairDayNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = festFair.diagram.providers.FestFairParserProvider.getParser(
					festFair.diagram.providers.FestFairElementTypes.FairDay_2001, getParserElement(),
					festFair.diagram.part.FestFairVisualIDRegistry
							.getType(festFair.diagram.edit.parts.FairDayNameEditPart.VISUAL_ID));
		}
		return parser;
	}
