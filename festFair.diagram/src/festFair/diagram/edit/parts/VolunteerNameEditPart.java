 ...
 * @generated
 */
public class VolunteerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public VolunteerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = festFair.diagram.providers.FestFairParserProvider.getParser(
					festFair.diagram.providers.FestFairElementTypes.Volunteer_2003, getParserElement(),
