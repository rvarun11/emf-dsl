...
public class WrappingLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(festFair.diagram.part.FestFairVisualIDRegistry
				.getType(festFair.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = festFair.diagram.providers.FestFairParserProvider.getParser(
					festFair.diagram.providers.FestFairElementTypes.VolunteerWork_4002, getParserElement(),
