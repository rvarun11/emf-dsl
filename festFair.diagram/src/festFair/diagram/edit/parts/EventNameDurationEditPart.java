 ...
 * @generated
 */
public class EventNameDurationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EventNameDurationEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = festFair.diagram.providers.FestFairParserProvider.getParser(
					festFair.diagram.providers.FestFairElementTypes.Event_3004, getParserElement(),
					festFair.diagram.part.FestFairVisualIDRegistry
							.getType(festFair.diagram.edit.parts.EventNameDurationEditPart.VISUAL_ID));
		}
		return parser;
	}
