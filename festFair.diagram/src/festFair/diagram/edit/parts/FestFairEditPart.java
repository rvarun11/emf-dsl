 ...
 * @generated
 */
public class FestFairEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "FestFair"; //$NON-NLS-1$
	...
	* @generated
	*/
	public FestFairEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new festFair.diagram.edit.policies.FestFairItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new festFair.diagram.edit.policies.FestFairCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new festFair.diagram.edit.commands.FestFairCreateShortcutDecorationsCommand(
