	...
	*/
	static {
		registerSnapBackPosition(festFair.diagram.part.FestFairVisualIDRegistry
				.getType(festFair.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = festFair.diagram.providers.FestFairParserProvider.getParser(
					festFair.diagram.providers.FestFairElementTypes.GuestVisit_4001, getParserElement(),
