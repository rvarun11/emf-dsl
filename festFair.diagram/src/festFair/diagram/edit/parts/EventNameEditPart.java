 ...
 * @generated
 */
public class EventNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
		...
		if (parser == null) {
			parser = festFair.diagram.providers.FestFairParserProvider.getParser(
					...
					festFair.diagram.part.FestFairVisualIDRegistry
							.getType(festFair.diagram.edit.parts.EventNameEditPart.VISUAL_ID));
		}
		return parser;
	}
