...
public class EventEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new festFair.diagram.edit.policies.EventItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof festFair.diagram.edit.parts.EventNameTimeEditPart) {
			((festFair.diagram.edit.parts.EventNameTimeEditPart) childEditPart)
