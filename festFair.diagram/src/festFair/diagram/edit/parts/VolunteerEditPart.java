...
public class VolunteerEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new festFair.diagram.edit.policies.VolunteerItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof festFair.diagram.edit.parts.VolunteerNameEditPart) {
			((festFair.diagram.edit.parts.VolunteerNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureVolunteerLabelFigure());
			return true;
		}
		return false;
	}
