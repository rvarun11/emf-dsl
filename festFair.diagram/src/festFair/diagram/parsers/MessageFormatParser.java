 ...
 * 
 */
package festFair.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(festFair.diagram.part.FestFairDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(festFair.diagram.part.Messages.MessageFormatParser_InvalidInputError,
