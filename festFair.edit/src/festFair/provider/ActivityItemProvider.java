...
/**
 * This is the item provider adapter for a {@link festFair.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGuestsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FestFairPackage.Literals.ACTIVITY__VOLUNTEER,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Guests feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGuestsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_guests_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_guests_feature", "_UI_Activity_type"),
				 FestFairPackage.Literals.ACTIVITY__GUESTS,
				 true,
				 false,
				 true,
				 null,
